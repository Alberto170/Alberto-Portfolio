...
function MobileNav({ open, setOpen }) {
    return (
        <div className={`absolute top-0 left-0 h-[40rem] w-full transform ${open ? "-translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out filter drop-shadow-md `}>
